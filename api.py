...
class Order(db.Model):
    ...
    def to_dict(self):
        return {
            ...
            'contents_declaration': self.contents_declaration,
            'despatch_date': self.despatch_date,
            'insurance': self.insurance,
            'final_insurance_charge' : self.final_insurance_charge,
            'insurance_premium_tax' : self.insurance_premium_tax,
...
@app.route('/quote', methods=['GET', 'PUT'])
def quote():
    form1 = AddRecord()
    if form1.validate_on_submit():
        ...
        updated = now.date() # Get today's date and time 
        ...
        if insurance == 'y':
            ...
            final_insurance_charge = 0 
            insurance_premium_tax = 0
        ...
        return render_template('quote.html')
    else: # When the /quote page first loads, or when the form input is not valid
...
def search():
    ...
    if request.method == "POST":
        ...
        return render_template('track.html', form1=form1)
